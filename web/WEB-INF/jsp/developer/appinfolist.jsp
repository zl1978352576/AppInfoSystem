                    ...
                    <ul>
                        ...
                        <li>
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="hidden" name="categorylevel2list" id="categorylevel2list" value="${categorylevel2list}"/>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    ...
                                                    <li><a class="modifyVersion"
                                                           ...
                                                           data-toggle="tooltip" data-placement="top" title="" data-original-title="修改APP版本"/>修改APP版本</a>
                                                    </li>
